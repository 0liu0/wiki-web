...
export default defineComponent({
  ...
  setup() {
    ...
    const titleClick = (cid: number) => {
      ...
      console.log("爸保护你:父" + selectInfo.value.category1Id+";子:"+selectInfo.value.category1Id);
    };
    // 点击子菜单时触发的操作
    const subTitleClick = (cid: number) => {
      selectInfo.value.category2Id = cid
      console.log("被偷家了:父" + selectInfo.value.category1Id+";子:"+selectInfo.value.category1Id);
    };
